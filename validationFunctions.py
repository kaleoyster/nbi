...
def stateCodeValidate(data,validation,structNumber,fieldErrorCountArray):
       ...
       if data in validValues:
          ...
          print('StateCode Value ('+ data +') Error in: ' + structNumber ,file = validation)
          error = 1
          return data , error         
...
def recordTypeValidate(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Record Type Validate Value ('+ data +') Error in: ' + structNumber ,file = validation)         
        error = 0
        return data , error 
...
def routeSigningPrefixValidate(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Routing Signing prefix Validate Value ('+ data +') Error in: ' + structNumber ,file = validation)         
        error = 1
        return data , error 
...
def DesignatedLevelServiceValidate(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Designated Level Service Validate Value ('+ data +') Error in: ' + structNumber ,file = validation)         
        error = 1
        return data , error 
...
def directionalSuffixValidate(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Directional Suffix Validate Value ('+ data +') Error in: ' + structNumber,file = validation)         
        error = 1
        return data , error 
...
def baseHighwayNetwork(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Base Highway Network ('+ data +') Error in: ' + structNumber,file = validation)         
        error = 1
        return data , error 
...
def LongitudeLatitudeValidate(longitude, latitude,validation,structNumber,fieldErrorCountArray):
    ...
    if((longitude > -180 and longitude < 180) and (latitude > -85 and latitude < 85)):
        ...
        print('Longitude('+ longitude +') and Latitude ('+ latitude +')  Invalid in: ' + structNumber , file = validation )
        return longitude, latitude, error
...
def tollValidate(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Toll Validate ('+ data +') Error in: ' + structNumber ,file = validation)         
        error = 1
        return data , error 
...
def maintenanceReponsibilityValidate(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Maintenance Responsibility  ('+ data +') Error in: ' + structNumber ,file = validation)         
        error = 1
        return data , error 
...
def OwnerValidate(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Owner  ('+ data +') Error in: ' + structNumber ,file = validation)         
        error = 1
        return data , error 
...
def FunctionalClassificationValidate(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Functional Classification Validate ('+ data +') Error in: ' + structNumber ,file = validation)         
        error = 1
        return data , error
...
def yearBuilt(data,validation,structNumber,fieldErrorCountArray):
    ...
    if (date < 2017):
        ...
        print('Year Built ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return date, error
...
def designLoadValidate(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Design Load ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data , error
...
def bridgeMedianValidate(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Bridge Median ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data , error
...
def structureFlaredValidate(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Structure Flared ('+ data +') Error in: ' + structNumber,file = validation)
        error = 1
        return data , error
...
def bridgeRailingsValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Bridge Railing, Features 36A ('+ data +') Error in: ' + structNumber,file = validation)
        error = 0
        return data , error
...
def transitionsValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Transition Validation, Traffic Safety Features 36B ('+ data +') Error in: ' + structNumber,file = validation)
        error = 0
        return data , error
...
def apporachGuardrailValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Apporach Guardrail Validation, Traffic Safety Features 36C('+ data +') Error in: ' + structNumber,file = validation)
        error = 0
        return data , error
...
def apporachGuardrailEndsValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Apporach Guardrail Ends Validation, Traffic Safety Features 36D ('+ data +') Error in: ' + structNumber,file = validation)
        error = 0
        return data , error
...
def historicalSigValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Historical Significance ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data , error
...
def navControlValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Navigation Control ('+ data +') Error in: ' + structNumber,file = validation)
        error = 0
        return data , error
...
def structureTypeValidate(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Structure Open/Posted/Closed to Traffic ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data , error
...
def typeOfServiceOnBridge(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Type Of Service On Bridge ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data , error
...
def typeOfServiceUnderBridge(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Type Of Service Under Bridge ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data , error
...
def kindOfMaterial(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Kind of Material, Structure Type ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data , error
...
def typeOfDesign(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Type of Design, Structure Type, Main 43B ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data , error
...
def structureTypeAspans44A(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Structure Type, Approach Spans 44A ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data , error
...
def structureTypeAspans44B(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Structure Type, Approach Spans 44B ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data , error
...
def minVerticalUnderclearanceRef(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Minimum Vertical Underclearance Reference feature 54A ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data , error
...
def minLateralUnderclearanceRef(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Minimum Lateral Underclearance Reference feature 54A ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data , error
...
def deckRatings(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Indicate the Condition Ratings Deck ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data , error
...
def superstructureRatings(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Indicate the Condition Ratings Superstructure('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data , error
...
def substructureRatings(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Indicate the Condition Ratings Substructure ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def channelProtectionValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Channel and Channel Protection ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def culvertsValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Culverts ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def methodUsedToDetermineOperatingRatingValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Method used to Operating Rating ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data, error

def operatingRatingValidation(data,validation,structNumber,fieldErrorCountArray):
    validValues = ['0',
                   '1',
                   '2',
                   '3',
    ...
    if data in validValues:
        ...
        fieldErrorCountArray[72] = fieldErrorCountArray[72] + 1
        print('Method used to Operating Rating ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data, error        
...
def methodToDetermineInventoryRating(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('MethodToDetermineInventory Rating ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data, error
...
def structuralEvalValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Structural Evaluation ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def deckGeometryValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Deck Geometry ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def underclearVerticalHorizontal(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('underclearVerticalHorizontal ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def bridgePosting(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Bridge Posting ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data, error
...
def waterwayAdequacyValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('waterwayAdequacyValidation('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def approachRoadwayAlignValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Approach Roadway Alignment ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def typeofWork75A(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Type of Work 75A ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def typeofWork75B(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Type of Work 75B ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def strahnetValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('STRAHNET Highway Designation ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data, error
...
def parallelStructureDesignationValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Parallel Structure Designation ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def directionOfTrafficValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Direction of Traffic ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data, error
...
def temporaryStructureValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Temporary Structure Designation  ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def highwaySystemInventoryRouteValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Highway System of the Inventory Route ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data, error
...
def federalLandsHighwaysValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Federal Lands Highways ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data, error
...
def yearReconstructed(data,validation,structNumber,fieldErrorCountArray):
    ...
    if (date < 2017):
        ...
        print('Year Reconstructed ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return date, error
...
def deckStructureTypeValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Deck Structure Type ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def wearingSurfaceValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Type of Wearing Surface 108A ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def TypeOfMembraneValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Type of Membrane 108B ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def deckProtectionValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Deck Protection 108C ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def designatedNationalNetworkValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Designated National Network ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 1
        return data, error
...
def navProtectionValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Pier or Abutment Protection ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def bridgeLengthNBIS(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('NBIS Bridge Length ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
def scourCriticalValidation(data,validation,structNumber,fieldErrorCountArray):
    ...
    if data in validValues:
        ...
        print('Scour Critical Bridges ('+ data +') Error in: ' + structNumber ,file = validation)
        error = 0
        return data, error
...
#print(LongitudeLatitudeValidate(32, 32))
#print(recordTypeValidate('K'))
#print(stateCodeValidate('01'))
#print(routeSigningPrefixValidate('7'))
#print(directionalSuffixValidate('5'))
## Item No 19, 20
