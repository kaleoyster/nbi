...
DF['6A: Feature Imtersected'] = DF['6A: Features Intersected'].str.strip("'").str.strip()
DF['Facility Carried By Structure'] = DF['7: Facility Carried By Structure'].str.strip("'").str.strip()
